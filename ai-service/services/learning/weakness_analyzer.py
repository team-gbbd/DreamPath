...
학습자의 오답 패턴을 분석하여 약점을 파악하고 맞춤형 학습 조언을 제공해주세요.
...
## 분석 요청
1. 오답 패턴에서 공통적인 약점 영역을 찾아 태그로 분류
2. 각 약점의 심각도 평가 (high/medium/low)
3. 구체적인 학습 권장사항 제시
4. 역량 영역별 점수 산출 (레이더 차트용)

## 역량 영역
"{domain}" 분야에 가장 적합한 5가지 핵심 역량을 선정하여 평가해주세요.
예시:
- 백엔드 개발: 코딩 기초, API 설계, DB 이해, 보안, 시스템 설계
- 재무 분석가: 재무제표 분석, 투자 평가, 리스크 관리, 규제 이해, 보고서 작성
- 셰프: 조리 기초, 식재료 지식, 위생관리, 메뉴 구성, 원가 관리
- UX 디자이너: 사용자 리서치, UI 설계, 프로토타이핑, 접근성, 디자인 시스템

## JSON 형식으로 출력
{{
  "weaknessTags": [
    {{
      "tag": "약점 태그명 (구체적으로, 예: SQL 조인 이해)",
      "count": 해당_약점_오답_개수,
      "severity": "high" | "medium" | "low",
      "description": "이 약점에 대한 간단한 설명"
    }}
  ],
  "recommendations": [
    "구체적인 학습 권장사항 1",
  ...
  "overallAnalysis": "종합적인 분석 결과 (2-3문장)",
  "radarData": [
    {{"category": "역량1 (도메인에 맞게)", "score": 0-100, "fullMark": 100}},
    {{"category": "역량2 (도메인에 맞게)", "score": 0-100, "fullMark": 100}},
    {{"category": "역량3 (도메인에 맞게)", "score": 0-100, "fullMark": 100}},
    {{"category": "역량4 (도메인에 맞게)", "score": 0-100, "fullMark": 100}},
    {{"category": "역량5 (도메인에 맞게)", "score": 0-100, "fullMark": 100}}
  ]
}}"""
