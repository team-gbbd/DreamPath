...
API_URL = 'https://apis.data.go.kr/B490007/ncsJobBasCom'
API_KEY = '12fe084e6eb3bce105546b0e6d1622b0227b900d7d466bf4dd35a4575c5a4b25'


class NCS_JobCom_Ingest:
    ...
    def ingest_one(self, item):
        dto = {
            'ncsCd': item.get('ncsUnitCd', ''),
            'dutyName': item.get('elemNm', ''),
            'dutyDesc': item.get('elemExpl', ''),
            'jobTask': item.get('train', ''),
            'autonomy': '',
            'responsibility': '',
            'requiredMajor': '',
            'requiredCert': '',
        ...
        vector_id = f"ncs_jobcom_{dto['ncsCd']}_{uuid.uuid4()}"
